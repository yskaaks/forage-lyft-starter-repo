...
class TestSpindlerBattery(unittest.TestCase):
    def test_needs_service(self):
        battery = SpindlerBattery(last_service_date=datetime.today() - timedelta(days=366), current_date=datetime.today())
        self.assertTrue(battery.needs_service())

    def test_does_not_need_service(self):
        battery = SpindlerBattery(last_service_date=datetime.today() - timedelta(days=364), current_date=datetime.today())
